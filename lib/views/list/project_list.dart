...
import 'package:resttutiral/views/modify/project_modify.dart';
...
class _ProjectListState extends State<ProjectList> {
  ...
  APIResponse<List<Project>> _apiResponse;
  ...
  _fetchNotes()async{
    ...
    _apiResponse = await service.getProjectList("2");
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            Navigator.of(context)
                .push(MaterialPageRoute(builder: (_) => ProjectModify()))
                .then((_) {
              _fetchNotes();
            });
          },
              ...
              itemBuilder: (_, index) {
                return Dismissible(
                  ...
                  confirmDismiss: (direction) async {
                    ...
                    if(result)
                    {
                      final deleteResult = await service.deleteProject(_apiResponse.data[index].id);
                      var message;
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (_) => ( isSw ? ProjectModify(id: _apiResponse.data[index].id):
